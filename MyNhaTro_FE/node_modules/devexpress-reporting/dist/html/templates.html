...
<script type="text/html" id="dx-picture-editing-popup">
    <div class="dx-picture-edit-popup-content dx-picture-edit-popup-content-fullscreen" data-bind="dxPopup: {
            ...
            position: { boundary: $root.getPopupContainer($element), of: getPositionTarget($element), collision: 'flipfit flipfit' },
            container: $root.getPopupContainer($element),
            showTitle: false,
...
<script type="text/html" id="dxrv-daterange-calendar">
    <div tabIndex="0" class="dx-accessibility-calendar-item dx-accessibility-daterange-item" data-bind="dxCalendar: { value: value, cellTemplate: 'select_cell', height: height, min: min }">
...
﻿<script type="text/html" id="dx-picture-editing">
    <div class="dx-picture-editing">
        ...
        <div class="dx-picture-editing-active" data-bind="dxPopup: {
                ...
                position:{ my: 'left top', at: 'right top', boundary: $root.getPopupContainer($element), of: $data.$element, collision: 'fit fit', offset: '1 -1' },
                container: shadingEnabled() ? '.dx-overlay-wrapper.dx-picture-edit-popup-content-fullscreen' : $root.getPopupContainer($element),
                target: $root.getPopupContainer($element),
                showTitle: false,
...
<script type="text/html" id="dxrd-image-loadfile">
    <div data-bind="dxImageSourceEditor: { value: value, accept: 'image/*', type: 'img', disabled: disabled, showClearButton: true }"></div>
</script>
